...
//  PDSwitchExample
//
//  Created by Parth Dabhi on 9/3/15.
...
public class PDSwitchRoundedLayer: CALayer {
...
@IBDesignable
public class PDSwitch: UIControl {
    ...
    private func finishInit() {
        ...
        object_setClass(selectedBackgroundView.layer, PDSwitchRoundedLayer.self)
        addSubview(selectedBackgroundView)
        
        addSubview(selectedTitleLabelsContentView)
        
        object_setClass(titleMaskView.layer, PDSwitchRoundedLayer.self)
    ...
    override public class func layerClass() -> AnyClass {
        return PDSwitchRoundedLayer.self
    }
...
extension PDSwitch: UIGestureRecognizerDelegate {
